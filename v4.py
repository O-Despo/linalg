...
def lines_from_triange(points):
    ...
    lfnc = lambda x: x*((points[1][1]-points[0][1])/(points[1][0]-points[0][0]))+points[1][1]
    rfnc = lambda x: x*((points[1][1]-points[2][1])/(points[1][0]-points[2][0]))+points[1][1]
    return  lfnc, rfnc
...
#Debug run tri
pointss = run_tri_points(num_of_points, points_x_sub)
